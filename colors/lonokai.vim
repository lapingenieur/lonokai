" -----------------------------------------------------------------------------
" Name:         Lonokai
" Description:  Fork of sonokai : a high Contrast & Vivid Color Scheme based on Monokai Pro
...
if !(exists('g:colors_name') && g:colors_name ==# 'lonokai' && s:configuration.better_performance)
  highlight clear
  if exists('syntax_on')
    syntax reset
  endif
